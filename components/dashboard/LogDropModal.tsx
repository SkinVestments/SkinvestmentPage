      ...
      <div className="bg-steam-bg w-full max-w-lg rounded-2xl border border-steam-border shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <div className="p-5 border-b border-steam-border flex justify-between items-center bg-steam-elevated">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-steam-secondary">Log your rewards</p>
            </div>
          </div>
          <button onClick={onClose} className="text-steam-secondary hover:text-steam-text transition-colors p-1 hover:bg-steam-hover rounded-lg">
            <X className="w-6 h-6" />
          </button>
        </div>
            ...
            <>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-sm font-bold text-steam-text uppercase tracking-wider">Case Drop</h3>
              ...
              <div>
                <div className="flex justify-between items-center mb-3">
                   <h3 className="text-sm font-bold text-steam-secondary uppercase tracking-wider">Weapon / Graffiti</h3>
                   <span className="text-[10px] font-bold bg-steam-elevated text-steam-secondary px-2 py-1 rounded">SEARCH</span>
                </div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={`
                      ...
                      ${selectedSearchItem ? 'border-blue-500 text-blue-400 font-bold' : 'border-steam-border text-steam-text'}
                    `}
                  />
                  {isSearching && (
              ...
              <div className="space-y-3 pt-2 border-t border-steam-border">
                ...
                <div 
                  ...
                  className="flex items-center justify-between p-3 rounded-xl hover:bg-steam-hover cursor-pointer transition-colors -mx-2"
                >
                   <div className="flex items-center gap-3">
                      <div className={`p-1.5 rounded-lg transition-colors ${addToInvestments ? 'bg-blue-500/20 text-blue-400' : 'bg-steam-elevated/60 text-steam-tertiary'}`}>
                        <TrendingUp className="w-5 h-5" />
                      </div>
                      <div>
                        <p className={`text-sm font-bold transition-colors ${addToInvestments ? 'text-steam-text' : 'text-steam-secondary'}`}>Track as Investment</p>
                        <p className="text-xs text-steam-tertiary">Enable profit/loss tracking</p>
                      </div>
                   </div>
        ...
        <div className="p-5 border-t border-steam-border bg-steam-elevated">
           <div className="flex justify-between items-center mb-4">
              ...
              <span className={`text-lg font-bold font-mono transition-colors ${selectedPrice > 0 ? 'text-green-400' : 'text-steam-tertiary'}`}>
