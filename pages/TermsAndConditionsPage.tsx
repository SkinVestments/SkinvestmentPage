      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        <div className="prose prose-invert prose-lg max-w-none text-steam-secondary font-sans">
          ...
          <div className="space-y-8 bg-steam-card p-8 rounded-2xl border border-steam-border">
            ...
            <section>
              <h2 className="text-2xl font-bold text-steam-text mb-4">3. Data Accuracy</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-steam-text mb-4">4. User Accounts</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-steam-text mb-4">5. Intellectual Property & Affiliation</h2>
              <p>
                Skinvestments is an independent service and is <strong className="text-steam-text">not affiliated with, endorsed by, or sponsored by Valve Corporation or Steam.</strong> 
            ...
            <section>
              <h2 className="text-2xl font-bold text-steam-text mb-4">6. Limitation of Liability</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-steam-text mb-4">7. Contact</h2>
              <p>
