          ...
          <div className="space-y-8 bg-[#161B24] p-8 rounded-2xl border border-white/10">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-400">
                ...
                <li><strong className="text-white">Social Login Data:</strong> If you log in via Apple or Google, we receive basic profile information provided by those platforms.</li>
                ...
                <li><strong className="text-white">Analytics & Diagnostic Data:</strong> To optimize application performance, we collect anonymous or pseudonymous information about how you interact with the app, device identifiers (e.g., IDFV, Android ID), OS version, and crash reports.</li>
                <li><strong className="text-white">Advertising Data:</strong> In our mobile application, we use mobile advertising identifiers (such as Apple’s IDFA or Google’s Advertising ID) to serve advertisements.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-400 mt-2">
                ...
                <li><strong className="text-white">Steam (Valve Corp):</strong> Used for fetching inventory data.</li>
                <li><strong className="text-white">Market Data Providers:</strong> We aggregate non-personal, public pricing data from Steam Community Market, Skinport, and Buff163.</li>
                <li><strong className="text-white">Google LLC (Firebase Analytics & Crashlytics):</strong> Used to understand user behavior and monitor app stability.</li>
                <li><strong className="text-white">Google LLC (AdMob):</strong> Used to serve advertisements within our mobile application. AdMob may collect and process certain data to provide personalized or non-personalized ads.</li>
              </ul>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">4. Your Data Rights & Opt-Out</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-400">
                ...
                <li><strong className="text-white">Analytics & Crash Data Opt-Out:</strong> You can disable the sharing of diagnostic and usage data at any time via the toggle located in the app's Settings menu.</li>
                <li><strong className="text-white">Personalized Advertising Opt-Out:</strong> You can opt out of personalized ads by adjusting your device's privacy settings (e.g., turning on "Limit Ad Tracking" on iOS or "Opt out of Ads Personalization" on Android).</li>
              </ul>
            </section>
