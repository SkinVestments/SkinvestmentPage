...
const NotFound = () => {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4 animate-fade-in">
      ...
      <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-steam-text mb-4 tracking-tighter drop-shadow-lg">
        404
      </h1>
      
      <h2 className="text-2xl font-bold text-steam-secondary mb-6 uppercase tracking-wider">
        Page Not Found
      </h2>
      
      <p className="text-steam-tertiary max-w-md mb-10">
