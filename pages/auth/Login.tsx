      ...
      <div className="bg-steam-card p-8 rounded-2xl shadow-2xl w-full max-w-md border border-steam-border animate-fade-in relative overflow-hidden">
        ...
        <div className="flex flex-col gap-3 mb-6">
          ...
          <button 
            ...
            type="button"
            className="w-full flex items-center justify-center gap-3 bg-steam-elevated hover:bg-steam-hover border border-steam-border text-steam-text py-3 px-4 rounded-xl font-bold transition-colors shadow-sm"
          >
