...
const replacements = [
  ...
  [/bg-white\/5/g, 'theme-subtle'],
  [/bg-white\/10/g, 'theme-subtle-strong'],
  [/bg-white\/20/g, 'theme-subtle-strong'],
  [/bg-black\/20/g, 'theme-subtle'],
  [/bg-black\/40/g, 'theme-overlay'],
  [/bg-black\/50/g, 'theme-scrim'],
  [/border-white\/20/g, 'theme-border-faint'],
  [/shadow-blue-500\/20/g, 'theme-shadow-accent'],
  [/shadow-blue-500\/25/g, 'theme-shadow-accent'],
  [/shadow-blue-500\/40/g, 'theme-shadow-accent'],
  [/hover:text-blue-400/g, 'hover:text-steam-accent'],
  [/from-\[#1a1d24\]/gi, 'from-steam-elevated'],
  [/to-\[#141619\]/gi, 'to-steam-bg'],
  [/hover:bg-gray-900/g, 'hover:bg-steam-hover'],
  [/hover:bg-gray-100/g, 'hover:bg-steam-hover'],
  [/text-gray-900/g, 'text-steam-text'],
  [/after:border-gray-300/g, 'after:border-steam-border'],
  [/after:bg-white after:border/g, 'after:bg-steam-card after:border'],
];
